Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/dd665a5cb9d2d4a4198e1ee7154ebbb1"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.03494122,0.3691636,0.02061419,1).rgb, 0.0);
