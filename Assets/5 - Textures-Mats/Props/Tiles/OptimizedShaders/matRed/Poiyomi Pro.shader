Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/7ab4a6f44299e3d47bbc736d89179f85"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.7077566,0.02348936,0.02348936,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0.7077566,0.02348936,0.02348936,1).a;
				#else
