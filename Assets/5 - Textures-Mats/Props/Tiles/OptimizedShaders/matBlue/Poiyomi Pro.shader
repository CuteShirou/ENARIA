Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/b8542b73891f56e40adaf709d2df6167"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0,0.4897902,0.7986599,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0,0.4897902,0.7986599,1).a;
				#else
