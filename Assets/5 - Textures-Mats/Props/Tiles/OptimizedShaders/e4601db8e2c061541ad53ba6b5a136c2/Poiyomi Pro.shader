Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/e4601db8e2c061541ad53ba6b5a136c2"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.01194217,0.7299055,0.7433497,1).rgb, 0.0);
