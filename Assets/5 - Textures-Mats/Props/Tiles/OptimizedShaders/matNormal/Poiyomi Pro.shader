Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/c9132b558f9a8ba4a9146460dbd6934e"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.2195262,0.2195262,0.2195262,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0.2195262,0.2195262,0.2195262,1).a;
				#else
