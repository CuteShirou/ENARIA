Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/0dcb3c3c224820c4690d4f801eb7692a"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.09270984,0.673178,0.1352081,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0.09270984,0.673178,0.1352081,1).a;
				#else
