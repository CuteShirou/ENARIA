Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/1bc58744f428e4d4da5880224b8a79d2"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.1909999,0.02033604,0.006111992,1).rgb, 0.0);
