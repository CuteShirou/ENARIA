Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/fddb8e59fafb78841a0a61759e1a1039"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.3311688,0.3311688,0.3311688,1).rgb, 0.0);
