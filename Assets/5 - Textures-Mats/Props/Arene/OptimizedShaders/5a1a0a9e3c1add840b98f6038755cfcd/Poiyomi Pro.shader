Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/5a1a0a9e3c1add840b98f6038755cfcd"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.5,0.4155729,0.06099994,1).rgb, 0.0);
