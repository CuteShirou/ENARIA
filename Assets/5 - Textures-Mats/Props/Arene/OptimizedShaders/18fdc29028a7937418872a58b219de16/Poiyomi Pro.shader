Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/18fdc29028a7937418872a58b219de16"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.5,0.3963858,0.2755,1).rgb, 0.0);
