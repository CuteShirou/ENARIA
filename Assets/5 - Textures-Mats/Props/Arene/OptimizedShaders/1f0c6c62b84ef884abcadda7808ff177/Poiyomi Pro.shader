Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/1f0c6c62b84ef884abcadda7808ff177"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.2012986,0.08902749,0.0295909,1).rgb, 0.0);
