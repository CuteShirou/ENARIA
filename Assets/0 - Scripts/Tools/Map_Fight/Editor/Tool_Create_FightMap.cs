...
public class Tool_Create_FightMap : EditorWindow
{
    ...
    {
        GetWindow<Tool_Create_FightMap>("Combat Map Editor");
    }
    ...
    {
        var newMap = CreateInstance<Data_FightMap>();
        ...
        string folderPath = "Assets/Resources/List_FightMap";
