...
public class GroupMonsterTeleporter : MonoBehaviour
{
    ...
    [Header("Composition du groupe :")]
    [SerializeField] public List<GameObject> monstersInGroup;

    private void OnTriggerEnter(Collider other)
    {
        //A FAIRE: Une nouvelle condition pour eviter l'agro auto des monstres
