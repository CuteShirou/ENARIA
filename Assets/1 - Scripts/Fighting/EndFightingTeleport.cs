...
public class EndFightingTeleport : MonoBehaviour
{
#if UNITY_EDITOR
    ...
    public System.Collections.IEnumerator SwitchSceneAdditive(GameObject player)
    {
    ...
    public void SetCameraParentByName(string targetName)
    {
